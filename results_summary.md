...
| Workflow | Planted defects | Found | Partial | Missed | Correct lookalike items | False positives | Unplanted defects found |
|---|---:|---:|---:|---:|---:|---:|---:|
| Employee Offboarding and Access Revocation | 17 | 14 | 1 | 2 | 10 | 0 | 2 |
